        ...
        <SafeComponentWrapper>
            ...
            >
                ...
                >
                    ...
                    >Page 2 Example : The design philosophy!</Text>
                </View>
            </View>
            ...
            >
                ...
                >
                    <Text style={{textAlign: 'left'}}>
                        <Text>App working data and main components state/data (the stores):</Text><Text>{'\n'}</Text>
                        All app working data, and main components state is managed in your "stores."<Text>{'\n'}</Text>
                        ...
                        component's&nbsp;
                        state globally, such that their information can be shared across each other.<Text>{'\n'}</Text>
