...
export default function Login(props) {
  ...
  let showLogin =
    displayFieldExpectationSatisfied('viewAction', loginStore, (eOfX) =>
      isNullUndefined(eOfX),
    ) ||
  ...
  let LoginFormWithStores = WithStoresHoc(LoginForm, [
    'recipeBoxStore',
    'loginStore',
  ]);
  let SignUpFormWithStores = WithStoresHoc(SignUpForm, [
    'recipeBoxStore',
    'loginStore',
  ]);
